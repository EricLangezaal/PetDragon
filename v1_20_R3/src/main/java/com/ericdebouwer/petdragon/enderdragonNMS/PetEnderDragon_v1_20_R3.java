...
public class PetEnderDragon_v1_20_R3 extends EnderDragon implements PetEnderDragon {
        ...
        try {
            if (!BuiltInRegistries.ENTITY_TYPE.getOptional(mcKey).isPresent()) {
                ...
                Registry.register(BuiltInRegistries.ENTITY_TYPE, PetEnderDragon.ENTITY_ID,
                        EntityType.Builder.of(PetEnderDragon_v1_20_R3::new, MobCategory.MONSTER).noSummon().build(PetEnderDragon.ENTITY_ID));
            ...
            checkCrystals = EnderDragon.class.getDeclaredMethod("ge");
    ...
    public PetEnderDragon_v1_20_R3(EntityType<? extends EnderDragon> entitytypes, Level world) {
        this(world.getWorld());
    }

    public PetEnderDragon_v1_20_R3(World world) {
