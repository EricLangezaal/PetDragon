...
public enum Message {
	...
	NO_EGG("no-egg-permission"), EGG_HATCHED("egg-hatched"), EGG_RECEIVED("egg-received"),
	DRAGON_SPAWNED ("dragon-spawned"), DRAGON_REMOVED ("dragon-removed"), DRAGON_NOT_FOUND ("no-dragon-found-to-remove"), RANGE_INVALID("remove-range-invalid"),
