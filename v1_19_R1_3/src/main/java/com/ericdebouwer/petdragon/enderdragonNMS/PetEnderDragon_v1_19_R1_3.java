...
public class PetEnderDragon_v1_19_R1_3 extends EnderDragon implements PetEnderDragon {
        ...
        try {
            if (!Registry.ENTITY_TYPE.getOptional(mcKey).isPresent()) {
                ...
                Registry.register(Registry.ENTITY_TYPE, PetEnderDragon.ENTITY_ID,
                        EntityType.Builder.of(PetEnderDragon_v1_19_R1_3::new, MobCategory.MONSTER).noSummon().build(PetEnderDragon.ENTITY_ID));
    ...
    public PetEnderDragon_v1_19_R1_3(EntityType<? extends EnderDragon> entitytypes, Level world) {
        this(world.getWorld());
    }

    public PetEnderDragon_v1_19_R1_3(World world) {
