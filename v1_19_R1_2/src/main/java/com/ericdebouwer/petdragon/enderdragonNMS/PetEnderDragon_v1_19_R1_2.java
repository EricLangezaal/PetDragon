...
public class PetEnderDragon_v1_19_R1_2 extends EnderDragon implements PetEnderDragon {
        ...
        try {
            if (!Registry.ENTITY_TYPE.getOptional(mcKey).isPresent()) {
                ...
                Registry.register(Registry.ENTITY_TYPE, PetEnderDragon.ENTITY_ID,
                        EntityType.Builder.of(PetEnderDragon_v1_19_R1_2::new, MobCategory.MONSTER).noSummon().build(PetEnderDragon.ENTITY_ID));
            ...
            checkCrystals = EnderDragon.class.getDeclaredMethod("fJ");
    ...
    public PetEnderDragon_v1_19_R1_2(EntityType<? extends EnderDragon> entitytypes, Level world) {
        this(world.getWorld());
    }

    public PetEnderDragon_v1_19_R1_2(World world) {
