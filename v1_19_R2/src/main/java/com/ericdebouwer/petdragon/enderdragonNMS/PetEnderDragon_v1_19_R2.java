...
public class PetEnderDragon_v1_19_R2 extends EnderDragon implements PetEnderDragon {
        ...
        try {
            if (!BuiltInRegistries.ENTITY_TYPE.getOptional(mcKey).isPresent()) {
                ...
                Registry.register(BuiltInRegistries.ENTITY_TYPE, PetEnderDragon.ENTITY_ID,
                        EntityType.Builder.of(PetEnderDragon_v1_19_R2::new, MobCategory.MONSTER).noSummon().build(PetEnderDragon.ENTITY_ID));
            ...
            checkCrystals = EnderDragon.class.getDeclaredMethod("fM");
    ...
    public PetEnderDragon_v1_19_R2(EntityType<? extends EnderDragon> entitytypes, Level world) {
        this(world.getWorld());
    }

    public PetEnderDragon_v1_19_R2(World world) {
    ...
    public boolean hurt(EnderDragonPart entitycomplexpart, DamageSource damagesource, float f) {
        ...
        if (((EntityDamageSource) damagesource).isThorns()) return false;
